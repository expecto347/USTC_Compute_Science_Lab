...
HD_PWD='D:/VivadoProject/COD/Lab4/Multicycle_CPU_new/Multicycle_CPU_new.runs/dist_mem_512x32_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dist_mem_512x32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dist_mem_512x32.tcl
