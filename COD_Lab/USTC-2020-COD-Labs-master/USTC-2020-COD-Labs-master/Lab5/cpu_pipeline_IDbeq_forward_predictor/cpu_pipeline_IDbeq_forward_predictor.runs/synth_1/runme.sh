...
HD_PWD='D:/VivadoProject/COD/Lab5/cpu_pipeline_IDbeq_forward_predictor/cpu_pipeline_IDbeq_forward_predictor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dbu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dbu.tcl
