...
HD_PWD='C:/Users/expecto/Desktop/Lab/COD_Lab/Lab4/one_circle_CPU/one_circle_CPU.runs/ROM_Instruction_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ROM_Instruction.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ROM_Instruction.tcl
