...
HD_PWD='C:/Users/expecto/Desktop/Program/Lab/Digital_Electronics_Lab/Lab8/Lab8/Lab8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log T4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source T4.tcl -notrace
